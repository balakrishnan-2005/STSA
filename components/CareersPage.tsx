      ...
      <section id="open-positions" className="py-24 px-6 bg-background/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-16 space-y-4">
            <p className="text-muted-foreground">Don't see a role that fits? We're always looking for great talent.</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a 
                ...
                className="inline-flex items-center justify-center h-10 px-6 rounded-md bg-[#25D366] text-white font-medium hover:bg-[#128C7E] transition-colors gap-2"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
                At STS, we value autonomy, technical excellence, and continuous learning. We're a distributed team that thrives on clear communication and deep work.
              </p>
              <div className="space-y-4">
                {[
